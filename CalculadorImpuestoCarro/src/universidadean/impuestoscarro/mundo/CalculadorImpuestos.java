...
public class CalculadorImpuestos {
    ...
    public Vehiculo buscarVehiculoPorMarca() {
        Vehiculo buscado = null;
        String marca = JOptionPane.showInputDialog(null,"INGRESE LA MARCA DEL VEHICULO A BUSCAR");
    ...
    public Vehiculo buscarVehiculoPorLinea() {
        Vehiculo buscado = null;
        String linea = JOptionPane.showInputDialog(null,"INGRESE LA LINEA DEL VEHICULO A BUSCAR");
